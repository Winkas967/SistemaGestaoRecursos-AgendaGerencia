...
class ChecklistService:
    ...
    def to_dict(evaluation, checklist):
        ...
        return {
            ...
            "teveVisita": bool(checklist["teve_visita"]),
    ...
    def save(evaluation_id, checklist_id, data, user_id=None):
        ...
        checklist_data = {
            ...
            "teve_visita": bool(data.get("teveVisita")),
            "data_entrega_relatorio": ChecklistService.validate_date(data.get("dataEntregaRelatorio"), "Data de criação do checklist"),
